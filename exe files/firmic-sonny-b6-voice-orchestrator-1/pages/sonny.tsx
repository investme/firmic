  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-[#050816] text-white flex">
        ...
        <main className="flex-1 min-w-0 p-4 lg:p-7 overflow-hidden">
          <div className="max-w-[1700px] mx-auto">
            <header className="relative overflow-hidden rounded-[30px] border border-white/10 bg-gradient-to-br from-[#12152b] via-[#0d1022] to-[#24104d] p-6 lg:p-8 shadow-2xl">
              <div className="absolute -top-24 -right-20 h-72 w-72 rounded-full bg-violet-600/20 blur-3xl" />
              <div className="relative flex flex-col xl:flex-row xl:items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap gap-3">
                  <button
                    ...
                    className="border border-white/10 bg-white/5 px-4 py-3 rounded-2xl text-sm font-bold hover:bg-white/10"
                  >
                  ...
                  <button
                    onClick={load}
                    disabled={loading}
                    className="bg-white text-slate-950 px-5 py-3 rounded-2xl font-black disabled:opacity-50"
                  >
            ...
            {warning && (
              <div className="mt-5 border border-amber-400/25 bg-amber-400/10 text-amber-200 rounded-2xl p-4">
                {warning}
              </div>
            )}
                ...
                <section className="grid 2xl:grid-cols-[1.15fr_0.85fr] gap-5 mt-5">
                  <div className="space-y-5 min-w-0">
                    ...
                    >
                      ...
                      {pendingAction && (
                        <div className="mt-4 border border-amber-400/25 bg-amber-400/10 rounded-2xl p-4">
                          ...
                          <div className="flex gap-2 mt-4">
                            ...
                            <button
                              ...
                              className="border border-white/10 px-4 py-2 rounded-xl font-bold"
                            >
                              Cancel
                            </button>
                          </div>
                      ...
                      <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-3">
                        <textarea
                          ...
                          className="w-full min-h-[90px] resize-none bg-transparent text-white placeholder:text-slate-500 outline-none p-2"
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 mt-2">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className={`h-12 w-12 rounded-2xl font-black transition ${
                                listening
                            ...
                            <button
                              ...
                              disabled={working !== ""}
                              className="bg-gradient-to-r from-violet-600 to-fuchsia-600 px-6 py-3 rounded-2xl font-black disabled:opacity-50"
                            >
                  ...
                  <aside className="space-y-5 min-w-0">
                    ...
                    >
                      <div className="rounded-2xl bg-gradient-to-br from-violet-600/20 to-fuchsia-600/10 border border-violet-400/20 p-5">
                        <p className="text-lg leading-8 text-slate-100">
                          {summary}
                        </p>
                        <button
                          onClick={() => speak(summary)}
                          className="mt-4 border border-white/10 bg-white/5 px-4 py-2 rounded-xl text-sm font-bold"
                        >
                          Read brief aloud
                        </button>
                      </div>
          ...
          {assignments.map((assignment, index) => (
            <div key={assignment.id} className="relative pl-8">
              {index < assignments.length - 1 && (
                <div className="absolute left-[11px] top-8 bottom-[-18px] w-px bg-white/10" />
              )}
              <div className="absolute left-0 top-1.5 h-6 w-6 rounded-full bg-violet-500/20 border border-violet-400/30 flex items-center justify-center text-[10px]">
                {index + 1}
              </div>
              <AssignmentRow
...
function Panel({
  ...
  return (
    <section className="rounded-[28px] border border-white/10 bg-[#0b0f20]/90 p-5 lg:p-6 shadow-xl">
      <div className="mb-5">
...
function Metric({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-[#0b0f20] p-4">
...
function Action({
  ...
  return (
    <button
      onClick={onClick}
      disabled={busy}
      className="bg-violet-600 hover:bg-violet-500 px-4 py-2 rounded-xl text-sm font-black disabled:opacity-50"
    >
      {busy ? "Working..." : text}
    </button>
  );
...
function Quick({
  ...
  return (
    <button
      onClick={onClick}
      className="border border-white/10 bg-white/5 px-3 py-2 rounded-xl text-xs font-bold hover:bg-white/10"
    >
      {text}
    </button>
  );
...
function Empty({ text }: { text: string }) {
  return (
    <div className="rounded-2xl border border-dashed border-white/15 bg-white/[0.025] p-7 text-center text-sm text-slate-500">
      {text}
    </div>
  );
}
