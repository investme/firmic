...
export default function Dashboard() {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      detail: `${documents?.length || 0} documents currently available to the workspace.`,
      actor: "Hermes",
      tone: "blue" as const,
    },
    {
  ...
  const executiveFeed = [
    ...
    },
    {
      ...
      detail: `${documents?.length || 0} documents available.`,
      type: "info" as const,
    },
    {
      id: "ai-feed",
