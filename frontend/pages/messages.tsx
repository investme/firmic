        ...
        <header className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-500 mt-1">
              All VoIP, CRM, mailbox, meeting, and AI workforce messages in one place.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              {messages.map((msg) => (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-[120px_1fr_120px_90px] gap-3 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-violet-600 text-white rounded-3xl p-6 shadow-sm">
              ...
              <p className="text-violet-100 text-sm mt-2">
                Firmic routes calls, mail, CRM updates, and meeting notifications to the right AI employee.
              </p>
