...
function SonnyWorkspace({
  ...
  const contextText = buildCustomerSonnyPrompt({
    action: "custom",
    customPrompt:
      "Use this information as the active Customer Hub context for the user's next request.",
    companyName,
  ...
  return (
    <SonnyAssistant
      ...
      companyName={companyName}
      title="Sonny AI · Customer Hub"
      subtitle="Customer executive copilot"
      storageKey="firmic_customer_hub_sonny"
      ...
      quickActions={[
        {
          ...
          prompt:
            "Create a concise executive customer summary with relationship health, commercial position, risks, and immediate priorities.",
        },
        {
          id: "next-action",
          label: "Recommend next action",
          prompt:
            "Recommend the single best next commercial action and give me three execution steps.",
        },
        {
          id: "follow-up",
          label: "Draft follow-up email",
          prompt:
            "Draft a professional follow-up email with a subject line and one specific next step. Do not invent facts.",
        },
        {
          id: "proposal",
          label: "Create proposal outline",
          prompt:
            "Create a concise proposal outline with objective, scope, value, next step, and missing information.",
        },
      ]}
    />
  );
