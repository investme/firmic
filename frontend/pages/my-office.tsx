          ...
          <>
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8">
                    <Info
                      title="Office Rental"
                      value={`$${officePrice}/mo · AED ${toAED(officePrice)}/mo`}
                      icon="🏢"
                    />
            ...
            <section className="mt-6 bg-violet-600 text-white rounded-3xl p-6 shadow-sm">
              ...
              <p className="text-violet-100 mt-2 max-w-4xl">
                ...
                business infrastructure, communications, software, and an AI
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-5 mt-5">
              ...
              <Service
                title="Meeting Rooms"
                desc="Book professional rooms with Zoom connection."
                usd={25}
                suffix="/hr"
                icon="🏛️"
              />
              ...
              <Service
                title="Zoom Pro"
                desc="Host unlimited client and team meetings."
              ...
              <Service
                title="AI Workforce"
                desc="Hire AI employees to operate your company."
                usd={423}
                icon="🤖"
              />
