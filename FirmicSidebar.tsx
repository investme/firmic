...
export default function FirmicSidebar({ active = "Dashboard" }: Props) {
  const items = [
    ...
    ["Office Marketplace", "/virtual-offices"],
    ["Head Office", "/my-office"],
    ["AI Workforce", "/ai-workforce"],
    ["Digital Mailroom", "/mailbox"],
    ["Business Communications", "/voip-calls"],
    ["Meeting Center", "/meeting-rooms"],
    ["Sales Hub", "/crm"],
